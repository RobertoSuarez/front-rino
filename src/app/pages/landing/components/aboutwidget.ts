...
@Component({
    ...
    template: `
        <div id="about" class="py-12 sm:py-16 md:py-20 px-4 sm:px-6 md:px-8 bg-gradient-to-b from-transparent to-blue-50 dark:from-transparent dark:to-blue-950/10">
            <div class="grid grid-cols-12 gap-6 justify-center">
                <div class="col-span-12 text-center mb-8 sm:mb-12">
                    ...
                    <h2 class="text-surface-900 dark:text-surface-0 font-bold mb-4 text-3xl sm:text-4xl md:text-5xl">¿Qué es la plataforma?</h2>
                    <div class="w-24 h-1 bg-gradient-to-r from-blue-600 to-cyan-500 mx-auto mb-6 rounded-full"></div>
                    <span class="text-muted-color text-lg sm:text-xl block max-w-3xl mx-auto">Una experiencia educativa inmersiva que combina gamificación, narrativa cultural y tecnología de IA</span>
                </div>
                ...
                <div class="col-span-12 md:col-span-6 lg:col-span-4 p-0 mt-6 lg:mt-0">
                    <div class="group h-full rounded-xl bg-white dark:bg-gray-800 shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden transform hover:-translate-y-2">
                        <div class="p-6 sm:p-8 h-full flex flex-col">
                            ...
                            <h5 class="mb-4 text-surface-900 dark:text-surface-0 text-xl sm:text-2xl font-semibold">Aprendizaje Gamificado</h5>
                            <span class="text-surface-600 dark:text-surface-200 text-base sm:text-lg flex-grow">Aprende jugando con misiones, retos y recompensas que hacen divertido el proceso educativo.</span>
                ...
                <div class="col-span-12 md:col-span-6 lg:col-span-4 p-0 mt-6 lg:mt-0">
                    <div class="group h-full rounded-xl bg-white dark:bg-gray-800 shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden transform hover:-translate-y-2">
                        <div class="p-6 sm:p-8 h-full flex flex-col">
                            ...
                            <h5 class="mb-4 text-surface-900 dark:text-surface-0 text-xl sm:text-2xl font-semibold">Narrativa Cultural</h5>
                            <span class="text-surface-600 dark:text-surface-200 text-base sm:text-lg flex-grow">Contenido contextualizado con elementos culturales latinoamericanos para una experiencia más cercana.</span>
                            <div class="mt-6 pt-4 border-t border-gray-100 dark:border-gray-700">
                                <a href="#" class="text-blue-600 dark:text-blue-400 font-medium inline-flex items-center group-hover:text-blue-700 dark:group-hover:text-blue-300">
                                    Descubrir más
                                    <i class="pi pi-arrow-right ml-2 transition-transform group-hover:translate-x-1"></i>
                ...
                <div class="col-span-12 md:col-span-6 lg:col-span-4 p-0 mt-6 lg:mt-0">
                    <div class="group h-full rounded-xl bg-white dark:bg-gray-800 shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden transform hover:-translate-y-2">
                        <div class="p-6 sm:p-8 h-full flex flex-col">
                            ...
                            <h5 class="mb-4 text-surface-900 dark:text-surface-0 text-xl sm:text-2xl font-semibold">Tecnología de IA</h5>
                            <span class="text-surface-600 dark:text-surface-200 text-base sm:text-lg flex-grow">Guía personalizada con inteligencia artificial que adapta el contenido a tu ritmo de aprendizaje.</span>
                            <div class="mt-6 pt-4 border-t border-gray-100 dark:border-gray-700">
                                <a href="#" class="text-blue-600 dark:text-blue-400 font-medium inline-flex items-center group-hover:text-blue-700 dark:group-hover:text-blue-300">
                                    Descubrir más
                                    <i class="pi pi-arrow-right ml-2 transition-transform group-hover:translate-x-1"></i>
