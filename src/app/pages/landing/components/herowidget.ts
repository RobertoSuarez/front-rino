...
@Component({
    ...
    template: `
        <div
            id="hero"
            class="flex flex-col py-16 md:py-24 lg:py-32 overflow-hidden relative"
        ...
        >
            ...
            <div class="mx-auto px-6 md:px-8 lg:px-10 max-w-7xl relative z-10">
                <div class="grid grid-cols-12 items-center gap-8">
                    <div class="col-span-12 lg:col-span-6 mb-8 lg:mb-0">
                        ...
                        <h1 class="text-4xl sm:text-5xl md:text-6xl font-bold text-gray-900 leading-tight dark:text-white mb-4">
                        ...
                        <p class="font-normal text-lg sm:text-xl md:text-2xl leading-normal mt-4 md:mt-6 text-gray-700 dark:text-gray-300 max-w-xl">
                        ...
                        <div class="mt-6 md:mt-10 flex flex-wrap gap-3 md:gap-4">
                            <button
                                ...
                                routerLink="/landing"
                                fragment="about"
                                class="text-base md:text-lg px-4 md:px-6 py-2 md:py-3 shadow-lg bg-gradient-to-r from-blue-600 to-cyan-500 border-none"
                            ></button>
                            <button
                                pButton
                                pRipple
                                ...
                                routerLink="/landing"
                                fragment="features"
                                class="text-base md:text-lg px-4 md:px-6 py-2 md:py-3 p-button-outlined p-button-secondary"
                            ></button>
                        </div>
                    </div>
